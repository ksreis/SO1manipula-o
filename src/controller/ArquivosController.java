...
public class ArquivosController implements IArquivosController{
	...
	private String geraTxt() {
		...
		while (!linha.equalsIgnoreCase("fim")) {
			linha = JOptionPane.showInputDialog(null,  "Digite uma frase, Entrada de testo", JOptionPane.INFORMATION_MESSAGE);
	...
	@Override
	public void readFeile(String path, String nome) throws IOException {
		File arq = new File(path, nome);
